...
fdescribe('Test de validacion obligatorio', () => {
  ...
  it('evaluar un campo v invalido, sin Condiciones', () => {
  ...
  it('evaluar un campo obligatorio valido, sin Condiciones', () => {
    const validarRequerido: ValidatorFn = servicioValidacion.kcRequiredValidator(null);
    expect(validarRequerido(formControl)).toBeNull();
  });

  it('evaluar un campo obligatorio valido, con Condiciones a true', () => {
    spyOn(servicioCondiciones, 'evaluar').and.returnValue(true);
    const validarRequerido: ValidatorFn = servicioValidacion.kcRequiredValidator(null);
    expect(validarRequerido(formControl)).toBeNull();
  });
  it('evaluar un campo obligatorio invalido, con Condiciones a true', () => {
    spyOn(servicioCondiciones, 'evaluar').and.returnValue(true);
    const validarRequerido: ValidatorFn = servicioValidacion.kcRequiredValidator(null);
    formControl.setValue('');
    formControl.markAsTouched({ onlySelf: true });
  ...
  it('evaluar un campo obligatorio invalido, con Condiciones a false lo que lo no debe ser evaluado', () => {
